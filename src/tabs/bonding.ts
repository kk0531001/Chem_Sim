...
<p>The valence electrons are the electrons in an atom's outermost shell, and they are the only ones that take part in bonding. Most main-group atoms are stable once they have eight valence electrons, the number a full s and p set holds. Carbon starts with four valence electrons, so it needs four more and forms four bonds. Nitrogen starts with five and forms three. Oxygen starts with six and forms two.</p>
...
<p>Work a case through. Sodium is 0.93 on the Pauling scale and chlorine is 3.16, so ΔEN = 3.16 − 0.93 = 2.23. That is well past 1.8, so sodium gives its electron up and sodium chloride is a lattice of Na⁺ and Cl⁻ ions. A gap of only 0.5 would have left the bond polar covalent.</p>
