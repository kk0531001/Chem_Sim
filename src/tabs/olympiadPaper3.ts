...
export const paper3: OlympiadPaper = {
  ...
  partA: [
    ...
    { id: 'mock3-a-020', topic: 'lab', q: 'Which procedure gives the most precise volume delivery?', opts: ['a graduated beaker', 'a burette or pipette', 'a measuring cylinder', 'a conical flask, marked'], a: 1, why: 'Volumetric (Class A) pipettes and burettes are calibrated to ±0.01–0.05 mL — far more precise than a beaker or cylinder.' },
