...
export const paper2: OlympiadPaper = {
  ...
  partA: [
    { id: 'mock2-a-001', topic: 'stoich', q: 'How many oxygen atoms are in 0.50 mol of \\(\\ce{Al2(SO4)3}\\)?', opts: ['6.0×10²³', '3.6×10²⁴', '7.2×10²⁴', '1.8×10²⁴'], a: 1, why: '12 O per formula unit → 0.50 × 12 × 6.02×10²³ = 3.6×10²⁴.' },
    { id: 'mock2-a-002', topic: 'states', q: 'At the same T and P, equal volumes of two gases contain equal numbers of:', opts: ['atoms', 'molecules', 'electrons', 'grams'], a: 1, why: 'Avogadro\'s law — equal volumes at the same T, P contain equal numbers of molecules.' },
    ...
    { id: 'mock2-a-004', topic: 'kinetics', q: 'Doubling the concentration of a reactant quadruples the rate. The order in that reactant is:', opts: ['0', '1', '2', '3'], a: 2, why: 'rate ∝ [A]ⁿ; 2ⁿ = 4 → n = 2 (second order).' },
    { id: 'mock2-a-005', topic: 'equilibrium', q: 'For an exothermic equilibrium, increasing the temperature causes K to:', opts: ['increase', 'decrease', 'stay the same', 'become zero'], a: 1, why: 'Heat is a product; adding heat shifts left, lowering K (van\'t Hoff).' },
    { id: 'mock2-a-006', topic: 'acids', q: 'In aqueous solution \\(\\ce{HCl}\\), \\(\\ce{HBr}\\) and \\(\\ce{HClO4}\\) all appear to be equally strong acids. The reason is that:', opts: ['their Ka values happen to be identical', 'water levels them — each is converted completely to \\(\\ce{H3O+}\\), the strongest acid that can exist in water', 'they all contain a halogen', 'their conjugate bases are the same species'], a: 1, why: 'The <b>levelling effect</b>: any acid stronger than H₃O⁺ hands its proton entirely to water, so what you actually have in every case is a solution of H₃O⁺ and the acid\'s identity is invisible to a pH measurement. To rank them you must use a <i>differentiating</i> (less basic) solvent such as glacial acetic acid, in which the order HClO₄ > HBr > HCl becomes measurable. The mirror statement holds for bases: OH⁻ is the strongest base that can exist in water, which is why O²⁻ and NH₂⁻ react completely with it.' },
    { id: 'mock2-a-007', topic: 'acids', q: 'For \\(\\ce{HF}\\), Ka = 6.8×10⁻⁴. The pH of 0.10 M \\(\\ce{NaF}\\) is closest to:', opts: ['8.1', '5.9', '7.0', '10.9'], a: 0, why: 'F⁻ is the conjugate base of a weak acid, so it hydrolyses: Kb = Kw/Ka = 10⁻¹⁴/6.8×10⁻⁴ = 1.5×10⁻¹¹. Then [OH⁻] ≈ √(Kb·C) = √(1.5×10⁻¹²) = 1.2×10⁻⁶ → pOH = 5.92 → <b>pH = 8.08</b>. The 5.9 option is the trap: it is the pOH, and a salt of a weak acid cannot be acidic.' },
    ...
    { id: 'mock2-a-015', topic: 'bonding', q: 'Which compound contains both ionic and covalent bonding?', opts: ['\\(\\ce{NaCl}\\)', '\\(\\ce{CO2}\\)', '\\(\\ce{Na2SO4}\\)', '\\(\\ce{CH4}\\)'], a: 2, why: 'Na₂SO₄: ionic between Na⁺ and SO₄²⁻, covalent within the sulfate ion.' },
    { id: 'mock2-a-016', topic: 'organic', q: 'Which pair are geometric (cis–trans) isomers?', opts: ['butane / isobutane', 'cis- and trans-2-butene', 'ethanol / dimethyl ether', 'glucose / fructose'], a: 1, why: 'Restricted rotation about the C=C of 2-butene gives cis and trans forms.' },
    { id: 'mock2-a-017', topic: 'organic', q: 'The functional group in \\(\\ce{CH3COOH}\\) is:', opts: ['aldehyde', 'ketone', 'carboxylic acid', 'ester'], a: 2, why: 'The –COOH group is a carboxylic acid.' },
    { id: 'mock2-a-018', topic: 'organic', q: 'Which reagent oxidizes a primary alcohol all the way to a carboxylic acid?', opts: ['NaBH₄', 'hot acidified KMnO₄', 'H₂/Pd', 'PCC'], a: 1, why: 'Strong oxidant KMnO₄ takes a 1° alcohol → aldehyde → carboxylic acid (PCC stops at the aldehyde).' },
    { id: 'mock2-a-019', topic: 'descriptive', q: 'Which ion gives a brick-red flame test colour?', opts: ['\\(\\ce{Ca^2+}\\)', '\\(\\ce{Ba^2+}\\)', '\\(\\ce{K+}\\)', '\\(\\ce{Cu^2+}\\)'], a: 0, why: 'Ca²⁺ burns brick-red; Ba²⁺ green, K⁺ lilac, Cu²⁺ blue-green.' },
    { id: 'mock2-a-020', topic: 'atomic', q: 'A nuclide undergoes β⁻ decay. Its atomic number:', opts: ['increases by 1', 'decreases by 1', 'stays the same', 'decreases by 2'], a: 0, why: 'A neutron → proton + electron, so Z rises by 1 while A is unchanged.' },
    { id: 'mock2-a-021', topic: 'lab', q: 'A student reports a titre of 24.35 mL. The number of significant figures is:', opts: ['2', '3', '4', '5'], a: 2, why: '2, 4, 3, 5 are all significant → 4 significant figures.' },
    { id: 'mock2-a-022', topic: 'states', q: 'The osmotic pressure of a solution is measured mainly to determine a solute\'s:', opts: ['boiling point', 'molar mass', 'density', 'colour'], a: 1, why: 'π = MRT (or via molar concentration) — a sensitive colligative route to molar mass, good for macromolecules.' },
    { id: 'mock2-a-023', topic: 'thermo', q: 'For which reaction is ΔS most positive?', opts: ['\\(\\ce{H2O(l) -> H2O(s)}\\)', '\\(\\ce{2H2 + O2 -> 2H2O(l)}\\)', '\\(\\ce{CaCO3(s) -> CaO(s) + CO2(g)}\\)', '\\(\\ce{N2 + 3H2 -> 2NH3}\\)'], a: 2, why: 'A gas is produced from a solid — a large increase in disorder.' },
    ...
    { id: 'mock2-a-025', topic: 'atomic', q: 'How many photons of wavelength 500 nm carry a total energy of 3.97×10⁻¹⁹ J? (E = hc/λ, one photon)', opts: ['1', '2', '10', '0.5'], a: 0, why: 'One photon at 500 nm has E = hc/λ = (6.63×10⁻³⁴·3.0×10⁸)/(5.0×10⁻⁷) = 3.97×10⁻¹⁹ J — so exactly one photon.' },
  ],
  partB: [
    {
      id: 'mock2-b-001',
