...
export const paper4: OlympiadPaper = {
  ...
  partA: [
    ...
    { id: 'mock4-a-002', topic: 'states', q: 'Which gas effuses fastest through a small hole?', opts: ['\\(\\ce{O2}\\)', '\\(\\ce{CO2}\\)', '\\(\\ce{He}\\)', '\\(\\ce{Cl2}\\)'], a: 2, why: 'Graham\'s law: rate ∝ 1/√M; He (M = 4) is lightest, so it effuses fastest.' },
    { id: 'mock4-a-003', topic: 'thermo', q: 'The bond enthalpies (kJ/mol) are H–H 436, Cl–Cl 242, H–Cl 431. ΔH for \\(\\ce{H2 + Cl2 -> 2HCl}\\) is:', opts: ['−184 kJ', '−247 kJ', '+184 kJ', '−92 kJ'], a: 0, why: 'ΔH = Σbonds broken − Σbonds formed = (436+242) − 2(431) = 678 − 862 = −184 kJ.' },
    ...
    { id: 'mock4-a-005', topic: 'equilibrium', q: 'A 1.0 L flask at equilibrium holds 0.20 mol \\(\\ce{PCl5}\\), 0.10 mol \\(\\ce{PCl3}\\), 0.10 mol \\(\\ce{Cl2}\\) for \\(\\ce{PCl5 <=> PCl3 + Cl2}\\). Kc is:', opts: ['0.050', '0.20', '2.0', '0.10'], a: 0, why: 'Kc = [PCl₃][Cl₂]/[PCl₅] = (0.10)(0.10)/0.20 = 0.050.' },
    ...
    { id: 'mock4-a-007', topic: 'acids', q: '50.0 mL of 0.10 M HCl is mixed with 50.0 mL of 0.10 M NaOH. The resulting pH is:', opts: ['1.0', '7.0', '13.0', '3.5'], a: 1, why: 'Equal moles of strong acid and base exactly neutralize → neutral solution, pH = 7.' },
    { id: 'mock4-a-008', topic: 'equilibrium', q: 'Which addition would dissolve more solid \\(\\ce{CaCO3}\\)?', opts: ['add \\(\\ce{Na2CO3}\\)', 'add \\(\\ce{HCl}\\)', 'add \\(\\ce{CaCl2}\\)', 'lower the temperature'], a: 1, why: 'Acid removes CO₃²⁻ (as CO₂ + H₂O), shifting \\(\\ce{CaCO3 <=> Ca^2+ + CO3^2-}\\) right → more dissolves.' },
    ...
    { id: 'mock4-a-010', topic: 'redox', q: 'Balancing \\(\\ce{MnO4- + Fe^2+ -> Mn^2+ + Fe^3+}\\) in acid, the ratio of \\(\\ce{MnO4-}\\) to \\(\\ce{Fe^2+}\\) is:', opts: ['1:1', '1:5', '5:1', '2:3'], a: 1, why: 'Mn gains 5 e⁻, Fe loses 1 e⁻; balancing electrons needs 5 Fe²⁺ per MnO₄⁻ → 1:5.' },
    { id: 'mock4-a-011', topic: 'atomic', q: 'Which element has the highest second ionization energy relative to its first?', opts: ['Mg', 'Na', 'Al', 'Si'], a: 1, why: 'Na⁺ has a noble-gas configuration; removing a second electron breaks it, so IE₂ ≫ IE₁ for Na.' },
    { id: 'mock4-a-012', topic: 'bonding', q: 'Which species is diamagnetic?', opts: ['\\(\\ce{O2}\\)', '\\(\\ce{NO}\\)', '\\(\\ce{N2}\\)', '\\(\\ce{O2^-}\\)'], a: 2, why: 'N₂ has all electrons paired (bond order 3, no unpaired e⁻); O₂ and NO are paramagnetic.' },
    ...
    { id: 'mock4-a-014', topic: 'bonding', q: 'Which has the greatest lattice energy?', opts: ['\\(\\ce{NaCl}\\)', '\\(\\ce{KCl}\\)', '\\(\\ce{MgO}\\)', '\\(\\ce{CaO}\\)'], a: 2, why: 'Lattice energy ∝ (charges)/(distance); MgO has 2+/2− ions and small radii → the largest.' },
    { id: 'mock4-a-015', topic: 'acids', q: 'A solution conducts electricity well and turns litmus red. It is most likely:', opts: ['aqueous ethanol', 'aqueous glucose', 'dilute HCl', 'pure water'], a: 2, why: 'Strong electrolyte + acidic → a strong acid such as dilute HCl.' },
    { id: 'mock4-a-016', topic: 'organic', q: 'How many chirality (stereo) centres are in 2,3-dibromobutane, \\(\\ce{CH3CHBrCHBrCH3}\\)?', opts: ['0', '1', '2', '4'], a: 2, why: 'Both C2 and C3 carry four different groups → 2 stereocentres (giving meso and d/l forms).' },
    { id: 'mock4-a-017', topic: 'organic', q: 'Oxidation of ethanol with a limited amount of acidified dichromate gives:', opts: ['ethene', 'ethanoic acid', 'ethanal (acetaldehyde)', 'ethane'], a: 2, why: 'Controlled/partial oxidation of a 1° alcohol stops at the aldehyde, ethanal.' },
    { id: 'mock4-a-018', topic: 'descriptive', q: 'A gas turns limewater milky AND decolourises acidified \\(\\ce{KMnO4}\\). It is:', opts: ['\\(\\ce{CO2}\\)', '\\(\\ce{SO2}\\)', '\\(\\ce{H2}\\)', '\\(\\ce{NH3}\\)'], a: 1, why: 'Both CO₂ and SO₂ give a white precipitate with limewater (CaCO₃ and CaSO₃), so <span class="trap">the limewater test alone does not identify CO₂</span> — it identifies an acidic gas. SO₂ is also a reducing agent: it decolourises purple MnO₄⁻ and turns orange Cr₂O₇²⁻ green. CO₂ does neither, having sulfur\'s +4 → +6 route unavailable to carbon at +4.' },
    { id: 'mock4-a-019', topic: 'atomic', q: 'A nuclide emits a positron. The daughter has:', opts: ['Z+1, same A', 'Z−1, same A', 'Z−2, A−4', 'same Z and A'], a: 1, why: 'Positron (β⁺) emission converts a proton to a neutron → Z falls by 1, A unchanged.' },
    { id: 'mock4-a-020', topic: 'lab', q: 'Repeating an extraction with three small solvent portions instead of one large portion:', opts: ['extracts less', 'extracts more', 'extracts the same', 'only saves time'], a: 1, why: 'Multiple small extractions leave a smaller fraction \\([V_{aq}/(V_{aq}+KV_{org})]^n\\) → more solute recovered.' },
    { id: 'mock4-a-021', topic: 'states', q: 'The van\'t Hoff factor i for \\(\\ce{K2SO4}\\) (fully dissociated) is:', opts: ['1', '2', '3', '4'], a: 2, why: 'K₂SO₄ → 2 K⁺ + SO₄²⁻ = 3 particles.' },
    { id: 'mock4-a-022', topic: 'thermo', q: 'For \\(\\ce{A -> B}\\), ΔH = −40 kJ and ΔS = −120 J/K. Above what temperature is the reaction non-spontaneous?', opts: ['300 K', '333 K', '360 K', 'always spontaneous'], a: 1, why: 'ΔG = 0 at T = ΔH/ΔS = 40000/120 = 333 K; above this ΔG > 0 (non-spontaneous).' },
    { id: 'mock4-a-023', topic: 'redox', q: 'The equilibrium constant K and standard cell potential E° are related by:', opts: ['ΔG° = −nFE° = −RT ln K', 'K = nFE°', 'E° = RT/K', 'K = E°/n'], a: 0, why: 'Both equal −ΔG°: −nFE° = −RT ln K links the electrochemical and equilibrium descriptions.' },
    { id: 'mock4-a-024', topic: 'atomic', q: 'A photon must have at least 494 kJ/mol of energy to break a Cl–Cl bond. The longest wavelength that works is closest to:', opts: ['242 nm', '494 nm', '700 nm', '120 nm'], a: 0, why: 'E per photon = 494000/6.02×10²³ = 8.2×10⁻¹⁹ J; λ = hc/E = (6.63×10⁻³⁴·3.0×10⁸)/8.2×10⁻¹⁹ ≈ 2.4×10⁻⁷ m = 242 nm.' },
    { id: 'mock4-a-025', topic: 'kinetics', q: 'Which statement about a catalyst is FALSE?', opts: ['it lowers Ea', 'it is regenerated', 'it shifts the equilibrium toward products', 'it speeds forward and reverse equally'], a: 2, why: 'A catalyst does NOT shift equilibrium — it only helps the system reach equilibrium faster.' },
  ],
  partB: [
    {
      id: 'mock4-b-001',
