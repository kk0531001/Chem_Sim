...
export const paper2: OlympiadPaper = {
  ...
  partA: [
    ...
    { id: 'mock2-a-006', topic: 'acids', q: 'The conjugate base of \\(\\ce{HSO4^-}\\) is:', opts: ['\\(\\ce{H2SO4}\\)', '\\(\\ce{SO4^2-}\\)', '\\(\\ce{H2O}\\)', '\\(\\ce{OH-}\\)'], a: 1, why: 'Removing one H⁺ from HSO₄⁻ gives SO₄²⁻.' },
    { id: 'mock2-a-007', topic: 'acids', q: 'The pH of a 0.10 M solution of a weak acid with Ka = 1.0×10⁻⁵ is about:', opts: ['1.0', '3.0', '5.0', '7.0'], a: 1, why: '[H⁺] ≈ √(Ka·C) = √(10⁻⁵·0.10) = √10⁻⁶ = 10⁻³ → pH = 3.0.' },
