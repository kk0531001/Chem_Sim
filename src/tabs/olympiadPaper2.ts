...
export const paper2: OlympiadPaper = {
  ...
  partA: [
    ...
    { id: 'mock2-a-012', topic: 'atomic', q: 'Which species has the smallest radius?', opts: ['\\(\\ce{Na+}\\)', '\\(\\ce{O^2-}\\)', '\\(\\ce{F-}\\)', '\\(\\ce{Mg^2+}\\)'], a: 3, why: 'All are isoelectronic (10 e⁻); the highest nuclear charge (Mg, Z=12) pulls electrons in tightest.' },
    ...
    { id: 'mock2-a-017', topic: 'organic', q: 'The functional group in \\(\\ce{CH3COOH}\\) is:', opts: ['carboxylic acid', 'ketone', 'aldehyde', 'ester'], a: 0, why: 'The –COOH group is a carboxylic acid.' },
    ...
    { id: 'mock2-a-023', topic: 'thermo', q: 'For which reaction is ΔS most positive?', opts: ['\\(\\ce{H2O(l) -> H2O(s)}\\)', '\\(\\ce{2H2 + O2 -> 2H2O(l)}\\)', '\\(\\ce{N2 + 3H2 -> 2NH3}\\)', '\\(\\ce{CaCO3(s) -> CaO(s) + CO2(g)}\\)'], a: 3, why: 'A gas is produced from a solid — a large increase in disorder.' },
