...
export const paper4: OlympiadPaper = {
  ...
  partA: [
    ...
    { id: 'mock4-a-003', topic: 'thermo', q: 'The bond enthalpies (kJ/mol) are H–H 436, Cl–Cl 242, H–Cl 431. ΔH for \\(\\ce{H2 + Cl2 -> 2HCl}\\) is:', opts: ['−92 kJ', '−247 kJ', '+184 kJ', '−184 kJ'], a: 3, why: 'ΔH = Σbonds broken − Σbonds formed = (436+242) − 2(431) = 678 − 862 = −184 kJ.' },
    { id: 'mock4-a-004', topic: 'kinetics', q: 'The rate constant of a reaction roughly doubles for a 10 °C rise. This is explained by:', opts: ['a larger ΔH', 'a change in K', 'more molecules exceeding Ea (Arrhenius/Boltzmann)', 'lower activation energy'], a: 2, why: 'Higher T shifts the Maxwell–Boltzmann distribution so a larger fraction of collisions exceed Ea → k rises.' },
    { id: 'mock4-a-005', topic: 'equilibrium', q: 'A 1.0 L flask at equilibrium holds 0.20 mol \\(\\ce{PCl5}\\), 0.10 mol \\(\\ce{PCl3}\\), 0.10 mol \\(\\ce{Cl2}\\) for \\(\\ce{PCl5 <=> PCl3 + Cl2}\\). Kc is:', opts: ['0.20', '0.050', '2.0', '0.10'], a: 1, why: 'Kc = [PCl₃][Cl₂]/[PCl₅] = (0.10)(0.10)/0.20 = 0.050.' },
    ...
    { id: 'mock4-a-008', topic: 'equilibrium', q: 'Which addition would dissolve more solid \\(\\ce{CaCO3}\\)?', opts: ['add \\(\\ce{Na2CO3}\\)', 'add \\(\\ce{CaCl2}\\)', 'add \\(\\ce{HCl}\\)', 'lower the temperature'], a: 2, why: 'Acid removes CO₃²⁻ (as CO₂ + H₂O), shifting \\(\\ce{CaCO3 <=> Ca^2+ + CO3^2-}\\) right → more dissolves.' },
    ...
    { id: 'mock4-a-010', topic: 'redox', q: 'Balancing \\(\\ce{MnO4- + Fe^2+ -> Mn^2+ + Fe^3+}\\) in acid, the ratio of \\(\\ce{MnO4-}\\) to \\(\\ce{Fe^2+}\\) is:', opts: ['1:1', '2:3', '5:1', '1:5'], a: 3, why: 'Mn gains 5 e⁻, Fe loses 1 e⁻; balancing electrons needs 5 Fe²⁺ per MnO₄⁻ → 1:5.' },
    { id: 'mock4-a-011', topic: 'atomic', q: 'Which element has the highest second ionization energy relative to its first?', opts: ['Na', 'Mg', 'Al', 'Si'], a: 0, why: 'Na⁺ has a noble-gas configuration; removing a second electron breaks it, so IE₂ ≫ IE₁ for Na.' },
    ...
    { id: 'mock4-a-022', topic: 'thermo', q: 'For \\(\\ce{A -> B}\\), ΔH = −40 kJ and ΔS = −120 J/K. Above what temperature is the reaction non-spontaneous?', opts: ['300 K', '360 K', '333 K', 'always spontaneous'], a: 2, why: 'ΔG = 0 at T = ΔH/ΔS = 40000/120 = 333 K; above this ΔG > 0 (non-spontaneous).' },
    { id: 'mock4-a-023', topic: 'redox', q: 'The equilibrium constant K and standard cell potential E° are related by:', opts: ['K = nFE°', 'ΔG° = −nFE° = −RT ln K', 'E° = RT/K', 'K = E°/n'], a: 1, why: 'Both equal −ΔG°: −nFE° = −RT ln K links the electrochemical and equilibrium descriptions.' },
    ...
    { id: 'mock4-a-025', topic: 'kinetics', q: 'Which statement about a catalyst is FALSE?', opts: ['it lowers Ea', 'it is regenerated', 'it speeds forward and reverse equally', 'it shifts the equilibrium toward products'], a: 3, why: 'A catalyst does NOT shift equilibrium — it only helps the system reach equilibrium faster.' },
  ],
  partB: [
    {
      id: 'mock4-b-001',
