...
export const PART2: FRQ[] = [
  ...
  },
  {
    ...
    parts: [
      ...
      { q: '(c) Why is osmotic pressure so much more sensitive than freezing-point depression for a solute this large?', a: 'Both are the same underlying physics (count the dissolved particles), but the proportionality constants differ: RT ≈ 24.45 L·atm/mol at 25 °C versus Kf = 1.86 °C·kg/mol for water. <span class="trap">Those two do not divide — atm and °C are different dimensions, so there is no \'ten times more sensitive\' to be read off the ratio.</span> The sensitivity argument is entirely about what the instrument can resolve: standard instruments resolve fractions of a torr in osmotic pressure far more easily in practice than they resolve fractions of a thousandth of a degree in freezing point — so the theoretical amplification and the practical measurement resolution both favor osmotic pressure, compounding into the difference part (b) shows.' },
    ],
  },
  ...
  // ================= KINETICS =================
  {
    ...
    prompt: 'For A + B → products:<br><div class="table-scroll"><table class="ref-table"><tr><th>[A]₀ (M)</th><th>[B]₀ (M)</th><th>rate (M/s)</th></tr><tr><td>0.10</td><td>0.10</td><td>2.0×10⁻⁴</td></tr><tr><td>0.20</td><td>0.10</td><td>8.0×10⁻⁴</td></tr><tr><td>0.10</td><td>0.20</td><td>4.0×10⁻⁴</td></tr></table></div>',
    parts: [
  ...
  },
  {
    ...
    prompt: 'N₂O₄(g) ⇌ 2NO₂(g) is monitored in a sealed flask starting from pure N₂O₄:<br>' +
      '<div class="table-scroll"><table class="ref-table"><tr><th>t (s)</th><th>0</th><th>10</th><th>20</th><th>30</th><th>40</th></tr>' +
      '<tr><td>[N₂O₄] (M)</td><td>1.00</td><td>0.85</td><td>0.78</td><td>0.75</td><td>0.75</td></tr>' +
      '<tr><td>[NO₂] (M)</td><td>0</td><td>0.30</td><td>0.44</td><td>0.50</td><td>0.50</td></tr></table></div>',
    parts: [
  ...
  },
  {
    ...
    parts: [
      { q: '(a) Use the "x is small" shortcut to estimate [NO₂] at equilibrium.', a: 'Let x = [N₂O₄] reacted. Approximate 0.100 − x ≈ 0.100: (2x)²/0.100 ≈ 4.6×10⁻³ → x² = 1.15×10⁻⁴ → x ≈ 0.01072 M → <b>[NO₂] ≈ 0.0214 M</b>.' },
  ...
  },
  {
    ...
    parts: [
      ...
      { q: '(b) Using the approximation [NH₃]eq ≈ 1.0 M (i.e. assuming little of it is consumed), estimate the molar solubility s of AgCl in 1.0 M NH₃.', a: 'K = s²/(1.0)² → s = √(3.06×10⁻³) ≈ <b>0.0553 M</b> — about 4100× more soluble than in pure water (s(pure) = √Ksp = 1.34×10⁻⁵ M).' },
  ...
  },
  {
    ...
    prompt: '0.4504 g of a pure, solid, monoprotic acid is dissolved in 50.0 mL of water and titrated with 0.1000 M NaOH:<br>' +
      ...
      'Candidate acids:<br>' +
      '<div class="table-scroll"><table class="ref-table"><tr><th>acid</th><th>M / g·mol⁻¹</th><th>pK<sub>a</sub></th></tr>' +
      ...
      '<tr><td>ibuprofen</td><td>206.28</td><td>4.91</td></tr></table></div>',
    parts: [
  ...
  },
  {
    ...
    prompt: 'An element\'s PES shows four peaks. Binding energy falls left to right; relative areas are given:<br><div class="table-scroll"><table class="ref-table"><tr><th>peak</th><th>1</th><th>2</th><th>3</th><th>4</th></tr><tr><td>area</td><td>2</td><td>2</td><td>6</td><td>1</td></tr></table></div>',
    parts: [
  ...
  },
  {
    ...
    prompt: 'An unknown period-3 element X is studied two ways.<br>' +
      ...
      '<div class="table-scroll"><table class="ref-table"><tr><th>peak</th><th>1</th><th>2</th><th>3</th><th>4</th><th>5</th></tr><tr><td>relative area</td><td>2</td><td>2</td><td>6</td><td>2</td><td>1</td></tr></table></div>',
    parts: [
  ...
  },
  {
    ...
    parts: [
      ...
      { q: '(c) A classmate suggests these could instead be Paschen-series lines (n_f = 3). Show, using the 656.3 nm line, that this is not just unlikely but mathematically impossible.', a: 'With n_f = 3: 1/n_i² = 1/9 − 1.524×10⁶/1.097×10⁷ = 0.1111 − 0.1389 = <b>−0.0278</b>. A negative value for 1/n_i² is <span class="trap">not just "a bad fit" — it has no real solution at all</span>, since n_i² can never be negative. The Paschen series simply cannot produce a 656.3 nm line (its SHORTEST possible wavelength — the series limit, n_i = ∞ → n_f = 3 — is about 820 nm, and every Paschen line is longer than that; the longest, 4 → 3, is ~1875 nm). n_f = 2 is the only assignment consistent with the data.' },
  ...
  },
  {
    ...
    prompt: 'Nuclear masses are almost never tabulated; <b>atomic</b> masses are. Use these, all in unified mass units:<br><div class="table-scroll"><table class="ref-table"><tr><th>species</th><td><b>¹H atom</b></td><td><b>n</b></td><td><b>²H atom</b></td><td><b>³H atom</b></td><td><b>⁴He atom</b></td><td><b>⁵⁶Fe atom</b></td><td><b>²²Na atom</b></td><td><b>²²Ne atom</b></td></tr><tr><td>mass / u</td><td>1.007825</td><td>1.008665</td><td>2.014102</td><td>3.016049</td><td>4.002603</td><td>55.934936</td><td>21.994437</td><td>21.991385</td></tr></table></div>1 u = 931.494 MeV/c²; mₑc² = 0.511 MeV.',
    parts: [
  ...
  },
  {
    ...
    prompt: 'First ionization energies down group 13, in kJ/mol:<br><div class="table-scroll"><table class="ref-table"><tr><th>element</th><td><b>B</b></td><td><b>Al</b></td><td><b>Ga</b></td><td><b>In</b></td><td><b>Tl</b></td></tr><tr><td>IE₁</td><td>800.6</td><td>577.5</td><td>578.8</td><td>558.3</td><td>589.4</td></tr></table></div>For comparison, group 2 behaves itself: Be 899.5, Mg 737.7, Ca 589.8, Sr 549.5, Ba 502.9.',
    parts: [
  ...
  },
  {
    ...
    prompt: 'Data for MgO(s), all per mole of MgO formed:<br>' +
      '<div class="table-scroll"><table class="ref-table"><tr><th>step</th><th>ΔH (kJ/mol)</th></tr>' +
      ...
      '<tr><td>lattice energy, Mg²⁺(g) + O²⁻(g) → MgO(s)</td><td>?</td></tr></table></div>',
    parts: [
      ...
      { q: '(c) A purely ionic (point-charge electrostatic) model predicts lattice energies of about −3795 kJ/mol for MgO and about −833 kJ/mol for AgCl — yet the Born–Haber (experimental) value for AgCl is about −915 kJ/mol, a ~82 kJ/mol gap the point-charge model misses entirely, while MgO\'s two values (part a vs. −3795) agree to within a couple percent. What does that contrast say about the bonding in each compound?', a: 'MgO\'s close agreement means it is described well by a simple ionic point-charge picture — both ions have noble-gas-like electron clouds with nothing extra to distort. AgCl\'s large gap means real AgCl is <b>more stable than a pure ionic model predicts</b>, i.e. it has significant covalent character: Ag⁺ has a polarizing 18-electron pseudo-noble-gas core (poor shielding from the filled d-subshell), and it distorts the electron cloud of the polarizable Cl⁻ toward itself (Fajans\' rules) — extra electron density shared between the ions is exactly the stabilization a point-charge model can\'t capture.' },
    ],
  },
  {
    id: 'p2-bonding-004',
...

  {
    ...
    prompt: 'Lattice energy is never measured directly — it is obtained from a Born–Haber cycle. All values in kJ mol⁻¹:<br><div class="table-scroll"><table class="ref-table"><tr><td><b>step</b></td><td><b>NaCl</b></td><td><b>AgCl</b></td></tr><tr><td>ΔH°f (MCl, s)</td><td>−411</td><td>−127</td></tr><tr><td>ΔH°sub (M, s → g)</td><td>+107</td><td>+284</td></tr><tr><td>IE₁ (M)</td><td>+496</td><td>+731</td></tr><tr><td>½ D(Cl₂)</td><td>+122</td><td>+122</td></tr><tr><td>EA (Cl)</td><td>−349</td><td>−349</td></tr></table></div>A purely ionic calculation (Born–Landé, from the charges, radii and Madelung constant) predicts <b>−766 kJ mol⁻¹</b> for NaCl and <b>−833 kJ mol⁻¹</b> for AgCl.',
    parts: [
  ...
  },
  {
    ...
    prompt: 'An Ellingham diagram plots ΔG° against T for oxidations written <b>per mole of O₂</b>, so competing reactions can be compared directly. Use ΔH° and ΔS° as temperature-independent, all per mole of O₂:<br><div class="table-scroll"><table class="ref-table"><tr><td><b>reaction</b></td><td><b>ΔH° / kJ</b></td><td><b>ΔS° / J K⁻¹</b></td></tr><tr><td>2Zn(s) + O₂ → 2ZnO(s)</td><td>−696.6</td><td>−201.0</td></tr><tr><td>4/3Al(s) + O₂ → 2/3Al₂O₃(s)</td><td>−1117.1</td><td>−209.0</td></tr><tr><td>2C(s) + O₂ → 2CO(g)</td><td>−221.0</td><td>+178.8</td></tr></table></div>',
    parts: [
  ...
  },
  {
    ...
    prompt: 'A coloured complex is determined by visible spectrophotometry at λ<sub>max</sub>, in 1.00 cm cells. Five standards give:<br>' +
      '<div class="table-scroll"><table class="ref-table"><tr><th>c (10⁻⁴ M)</th><th>0 (blank)</th><th>2.00</th><th>4.00</th><th>6.00</th><th>8.00</th></tr>' +
      '<tr><th>A</th><td>0.045</td><td>0.233</td><td>0.420</td><td>0.610</td><td>0.796</td></tr></table></div>' +
  ...
  },
  {
    ...
    prompt: 'Adding HBr to buta-1,3-diene gives two products — 3-bromobut-1-ene (<b>1,2-adduct</b>) and 1-bromobut-2-ene (<b>1,4-adduct</b>) — in a ratio that depends only on temperature:<br><div class="table-scroll"><table class="ref-table"><tr><td><b>conditions</b></td><td><b>1,2-adduct</b></td><td><b>1,4-adduct</b></td></tr><tr><td>−80 °C</td><td>71%</td><td>29%</td></tr><tr><td>+40 °C</td><td>15%</td><td>85%</td></tr></table></div>',
    parts: [
  ...
  },
  {
    ...
    prompt: 'Alkaline hydrolysis of 4-substituted ethyl benzoates, 4-X-C₆H₄CO₂Et + HO⁻, was followed at 30 °C:<br><div class="table-scroll"><table class="ref-table"><tr><td><b>X</b></td><td><b>OCH₃</b></td><td><b>CH₃</b></td><td><b>H</b></td><td><b>Cl</b></td><td><b>NO₂</b></td></tr><tr><td>σ<sub>p</sub></td><td>−0.27</td><td>−0.17</td><td>0.00</td><td>+0.23</td><td>+0.78</td></tr><tr><td>10³k / M⁻¹s⁻¹</td><td>0.255</td><td>0.423</td><td>1.00</td><td>3.21</td><td>52.0</td></tr></table></div>The Hammett equation is log(k/k₀) = ρσ, where σ is defined so that ρ ≡ 1.00 for the ionisation of benzoic acids in water at 25 °C.',
    parts: [
  ...
  },
  {
    id: 'p2-organic-008',
    topic: 'organic',
    title: 'Why a heavier atom absorbs at a lower wavenumber',
    prompt: 'A bond stretch behaves as a harmonic oscillator: ν̄ = (1/2πc)·√(k/μ), where k is the force constant and μ = m₁m₂/(m₁+m₂) is the reduced mass. Take atomic masses as C = 12, H = 1, D = 2, O = 16, N = 14, and the C–H stretch of an alkane at <b>2960 cm⁻¹</b>.',
    parts: [
      { q: '(a) Predict the C–D stretching wavenumber, assuming deuteration does not change k.', a: 'Isotopic substitution changes the masses, not the electronic structure, so k is genuinely unchanged and ν̄ ∝ 1/√μ.<br>μ(C–H) = (12×1)/13 = 0.923 · μ(C–D) = (12×2)/14 = 1.714.<br>ν̄(C–D) = 2960 × √(0.923/1.714) = 2960 × √0.5385 = 2960 × 0.7338 = <b>2170 cm⁻¹</b>. (Observed values fall near 2100–2200 ✓.) Notice the ratio is close to 1/√2 = 0.707, because the reduced mass of a bond to hydrogen is dominated by the light atom — doubling H to D nearly doubles μ, while the carbon barely matters.' },
      { q: '(b) A C–D stretch lands in the 2100–2260 cm⁻¹ window, which is otherwise reserved for triple bonds. Explain how deuteration is nonetheless used as an assignment tool rather than being a nuisance.', a: 'Deliberately deuterating one position and re-running the spectrum shifts <i>only</i> the bands involving that hydrogen, by the predictable √μ factor, and leaves everything else where it was. Any band that moves belongs to the labelled atom. It is the cleanest way to assign a congested spectrum, because it perturbs the masses without perturbing the chemistry — the one experimental knob in vibrational spectroscopy that changes μ alone.' },
      { q: '(c) The O–H stretch of a dilute alcohol in CCl₄ is a sharp band at 3620 cm⁻¹; concentrated, it becomes a broad hump centred near 3350 cm⁻¹. Since μ is unchanged, what has changed, and why is the band broad rather than merely shifted?', a: 'The reduced mass is fixed, so the <b>force constant</b> must have fallen. Hydrogen bonding O–H···O withdraws electron density from the O–H bond and weakens it, lowering k and therefore ν̄. The <b>broadening</b> follows from the same cause: hydrogen-bonded aggregates exist in a continuous distribution of geometries and strengths — dimers, trimers, chains, each with a slightly different k — and the observed band is the envelope of all of them. A sharp band means one well-defined environment; a broad band means many. That is why the carboxylic-acid dimer, held by two strong hydrogen bonds, gives the broadest O–H of all, smeared from 2500 to 3300 cm⁻¹.' },
      { q: '(d) Rank the stretching wavenumbers of C≡N, C=N and C–N, and say which factor in the equation dominates the trend. Then explain why C=O (~1715) absorbs higher than C=C (~1650) even though the two have similar reduced masses.', a: 'C≡N (~2250) > C=N (~1650) > C–N (~1100). Here μ is essentially constant across the series, so the whole trend is <b>k</b>: a triple bond is stiffer than a double, which is stiffer than a single. Bond order sets the force constant.<br>For C=O versus C=C the reduced masses are 6.86 and 6.00, so μ works slightly AGAINST C=O — with equal k it would land near 1544 cm⁻¹, below C=C. It absorbs higher because k does not stay equal: the stronger, more polar C=O has k ≈ 12.1 mdyn Å⁻¹ against ≈ 9.6 for C=C, and that ~25% stiffer bond more than offsets the heavier reduced mass. The <b>intensity</b> difference is the second half of the story. IR absorption requires a changing dipole moment, and stretching the strongly polar C=O sweeps a large dipole change, giving an intense band, while a symmetric C=C sweeps almost none and can be nearly invisible. <span class="trap">Position tells you what kind of bond; intensity tells you how polar it is. A weak band at 1650 and a strong band at 1715 are different pieces of evidence, and reading only the wavenumber discards half the information in the spectrum.</span>' },
    ],
  },
  {
    id: 'p2-organic-009',
    topic: 'organic',
    tier: 4, // quantitative NMR: the integration that students are taught to trust, used as a real analytical measurement, with the two conditions that make it valid
    title: 'Weighing a sample with a magnet',
    prompt: 'Quantitative ¹H NMR (qNMR) determines purity without a reference standard of the analyte itself. A sample of an ibuprofen-like drug (M = 206.3 g/mol) is analysed: <b>21.4 mg</b> of sample and <b>10.0 mg</b> of maleic acid internal standard (M = 116.1, purity 99.9%, two equivalent vinyl protons appearing as a 2H singlet at δ 6.3) are dissolved together in one NMR tube. The drug\'s isolated 3H doublet at δ 0.9 integrates to <b>3.00</b>; the standard\'s 2H singlet integrates to <b>1.86</b> on the same scale.',
    parts: [
      { q: '(a) Find the moles of internal standard, then the moles of drug.', a: 'n(std) = (10.0×10⁻³ × 0.999)/116.1 = <b>8.605×10⁻⁵ mol</b>.<br>Integration is proportional to the number of protons, so moles ∝ (integral ÷ protons per molecule):<br>n(drug) = n(std) × [I(drug)/N(drug)] ÷ [I(std)/N(std)] = 8.605×10⁻⁵ × (3.00/3)/(1.86/2) = 8.605×10⁻⁵ × (1.000/0.930) = <b>9.253×10⁻⁵ mol</b>.' },
      { q: '(b) Report the purity of the drug sample as a mass percentage.', a: 'mass of drug present = 9.253×10⁻⁵ × 206.3 = 0.01909 g = 19.09 mg.<br>purity = 19.09/21.4 × 100 = <b>89.2%</b>.<br>The remaining 11% is residual solvent, water, or unreacted starting material — none of which needs to be identified for the assay to be valid, which is the method\'s main practical advantage.' },
      { q: '(c) qNMR is a primary ratio method: it needs no calibration curve and no authentic sample of the analyte. Explain why not, and give the two experimental conditions that must be met for the integrals to be trustworthy.', a: 'Every proton in the tube, whatever molecule it belongs to, absorbs with the same intrinsic intensity — the ¹H nucleus is the same nucleus everywhere. So the integral ratio <i>is</i> the proton ratio, with no response factor to determine. Contrast chromatography, where each compound has its own detector response and needs its own standard.<br>Two conditions: (1) a <b>relaxation delay of at least 5×T₁</b> between pulses, so every proton has returned to equilibrium and none is under-counted — the usual failure mode, since T₁ varies between environments; (2) the chosen signals must be <b>fully resolved</b>, with no overlap from the standard, the solvent, or an impurity. A good internal standard is also chemically inert toward the analyte, non-volatile, of known high purity, and gives a simple singlet clear of the crowded regions.' },
      { q: '(d) A colleague runs the same sample using ¹³C integrals instead and gets a wildly wrong answer. Explain, and identify one class of impurity that qNMR would miss entirely even when run correctly.', a: '¹³C integrals are not proportional to carbon count for two independent reasons, both uneven across a molecule: broadband proton decoupling adds a <b>nuclear Overhauser enhancement</b> that scales with the number of attached protons, so a CH₃ carbon is boosted far more than a quaternary one; and quaternary carbons have <b>long T₁</b> values, so they are under-recovered at normal pulse rates. Quantitative ¹³C requires inverse-gated decoupling plus very long delays, and is rarely worth the hours it takes.<br>The blind spot: qNMR sees only <b>protons</b>. Inorganic salts, water content in a deuterated solvent whose HDO peak overlaps nothing, and any impurity without a resolved ¹H signal are invisible — so a qNMR purity is really "purity with respect to proton-bearing organic material". Pair it with Karl Fischer for water and with an ash or ICP determination for inorganics before calling a number an absolute purity.' },
    ],
  },
  {
    id: 'p2-organic-010',
    topic: 'organic',
    title: 'Two isomers, one formula, four spectra',
    prompt: 'Three compounds share the formula <b>C₈H₈O₂</b> (M⁺ = 136). Their data:<br><div class="table-scroll"><table class="ref-table"><tr><td></td><td><b>A</b></td><td><b>B</b></td><td><b>C</b></td></tr><tr><td>IR / cm⁻¹</td><td>2500–3300 (v. broad), 1705</td><td>1720, 1280 &amp; 1120</td><td>1740, 1230</td></tr><tr><td>¹H δ</td><td>12.1 (1H, s); 7.4–7.3 (5H, m); 3.6 (2H, s)</td><td>8.0 (2H, d); 7.5 (3H, m); 3.9 (3H, s)</td><td>7.4–7.1 (5H, m); 5.1 (2H, s); 2.1 (3H, s)</td></tr><tr><td>¹³C signals</td><td>6</td><td>6</td><td>7</td></tr></table></div>',
    parts: [
      { q: '(a) Compute the degrees of unsaturation and say what it forces to be present in all three.', a: 'DoU = (2×8 + 2 − 8)/2 = 10/2 = <b>5</b>. Four of those are a benzene ring (three π bonds plus the ring), which every ¹H spectrum confirms with its 5H or 2H+3H aromatic multiplets. The fifth is one more π bond — and since every IR shows a strong band between 1690 and 1765 cm⁻¹, in all three it is a <b>C=O</b>. So each compound is a monosubstituted or para-disubstituted benzene carrying a one-carbon-plus-two-oxygen unit distributed somehow.' },
      { q: '(b) Assign A, and say which of its protons would disappear on shaking with D₂O.', a: 'A very broad O–H spanning the C–H region plus a 1H singlet at δ 12.1 is a <b>carboxylic acid</b> — no other proton in organic chemistry appears that far downfield. Accounting for the hydrogens: 5 aromatic + 2 + 1 = 8 ✓, and the 2H singlet at δ 3.6 is a CH₂ with no neighbours, flanked by the ring on one side and the carbonyl on the other. A is <b>phenylacetic acid</b>, PhCH₂COOH. Its ¹³C count checks: 4 ring types + CH₂ + COOH = <b>6</b> ✓.<br>Only the <b>δ 12.1</b> proton exchanges with D₂O — it is the one bound to oxygen. The δ 3.6 CH₂ is bound to carbon and stays put, which is how you would confirm the assignment in a minute at the bench.' },
      { q: '(c) Assign B and C, using the carbonyl positions and the singlets.', a: '<b>B — methyl benzoate</b>, PhCOOCH₃. The 3H singlet at δ 3.9 is a methyl on oxygen (an ester OCH₃ sits at 3.7–4.0); C=O at 1720 with two strong C–O stretches; the 2H doublet at δ 8.0 is the pair of ortho protons deshielded by the ester carbonyl, which is why a monosubstituted ring here reads as 2H + 3H rather than one 5H multiplet.<br><b>C — benzyl acetate</b>, PhCH₂OCOCH₃. Its 3H singlet is at δ 2.1, an acetyl methyl on <i>carbon</i>, and the 2H singlet at δ 5.1 is a CH₂ attached to an ester oxygen. Its carbonyl sits <b>higher</b> (1740 vs 1720) because B\'s C=O is conjugated directly to the ring, which lowers the bond order and the wavenumber; in C the ring is one atom further away and cannot conjugate.' },
      { q: '(d) B and C both have six carbons in the ring region and one carbonyl, yet B shows 6 ¹³C signals and C shows 7. Account for the difference, and name the single fastest experiment to tell A from B.', a: 'Both rings are monosubstituted, so each contributes <b>4</b> distinct carbons (ipso, ortho pair, meta pair, para). B then adds C=O and OCH₃ → <b>6</b>. C adds C=O, OCH₂ and CH₃ → <b>7</b>. The extra signal is simply C\'s extra carbon environment; the ring symmetry is identical in both.<br>Fastest A/B discrimination: <b>shake with aqueous NaHCO₃</b>. A is a carboxylic acid and dissolves with visible effervescence (CO₂); B is an ester and does not. It takes seconds, needs no instrument, and separates them on the one property — acidity — that the two structures cannot share.' },
    ],
  },
  {
    id: 'p2-organic-011',
    topic: 'organic',
    title: 'When the spectrum is right and the answer is still wrong',
    prompt: 'A student is given an unknown of formula C₄H₈O₂ and reports it as <b>butanoic acid</b>. Their evidence: "M⁺ = 88 ✓; IR shows a strong C=O at 1740 cm⁻¹ ✓; the ¹H NMR shows a 3H triplet at δ 1.2, a 2H quartet at δ 4.1 and a 3H singlet at δ 2.0."',
    parts: [
      { q: '(a) Confirm the molecular formula is consistent with the mass, and compute the DoU.', a: 'Nominal mass = 4(12) + 8(1) + 2(16) = 48 + 8 + 32 = <b>88</b> ✓, and the even mass is consistent with the nitrogen rule for a nitrogen-free compound. DoU = (2×4 + 2 − 8)/2 = 2/2 = <b>1</b> — one ring or one π bond, satisfied by the carbonyl alone. So the molecule is acyclic with one C=O and no other unsaturation.' },
      { q: '(b) The student\'s formula and mass are right and their structure is wrong. Identify the two pieces of evidence that rule out butanoic acid.', a: 'Two independent contradictions:<br>(1) <b>No acid proton.</b> A carboxylic acid must show a 1H signal at δ 10–12, and there is none — the reported integrals account for all 8 hydrogens as 3 + 2 + 3. The IR would also have to show the enormous 2500–3300 O–H hump, and it reports only the carbonyl.<br>(2) <b>The carbonyl is in the wrong place.</b> An aliphatic carboxylic acid absorbs near 1710; <b>1740</b> is ester territory. Butanoic acid\'s own ¹H spectrum would be a 3H triplet, a 2H sextet, a 2H triplet and a 1H acid singlet — four signals, not three.' },
      { q: '(c) Give the correct structure and assign every signal.', a: '<b>Ethyl acetate</b>, CH₃COOCH₂CH₃.<br>δ 1.2 (3H, t) — the ethyl CH₃, split by the two CH₂ protons.<br>δ 4.1 (2H, q) — the OCH₂, split by the three CH₃ protons and pushed downfield to 4.1 by the ester oxygen.<br>δ 2.0 (3H, s) — the acetyl CH₃, a singlet because its neighbouring carbon is a carbonyl with no protons.<br>IR 1740 = ester C=O ✓, one degree of unsaturation ✓, no O–H ✓. <span class="trap">The triplet/quartet pair identifies an ethyl group but not what it is attached to — that is what the δ 4.1 shift is for. An ethyl on carbon would sit near δ 1.3/2.3.</span>' },
      { q: '(d) State the general procedural error, and give the order of operations that would have caught it.', a: 'The student worked <b>from a hypothesis backwards</b>, checking whether each piece of data was compatible with a structure they had already chosen, rather than letting the data narrow the field. Every individual observation they cited was true; none of them was <i>diagnostic</i>, and the two observations that would have refuted the guess — the missing acid proton and the exact carbonyl position — were the ones not examined.<br>The reliable order: <b>(1) formula and DoU</b> to bound the problem; <b>(2) IR</b> for which functional groups are present <i>and which are absent</i>; <b>(3) ¹H integration</b> to account for every hydrogen; <b>(4) splitting and shift</b> to connect the fragments; <b>(5) assemble, then re-predict the whole spectrum and check it against the data</b>. Step 5 is the one that catches this error, because predicting butanoic acid\'s spectrum immediately produces four signals where the data show three. Absences are evidence — a spectrum that fails to show a band you would expect is as informative as one that shows a band you did not.' },
    ],
  },
];
