...
export const TOPICS: TopicMeta[] = [
  { id: 'sandbox', title: 'Particle Sandbox', tag: 'Playground', group: 'Playground', wide: true, icon: 'flask', estMinutes: 20, difficulty: ['CCC'], prereqs: [],
    blurb: 'Spawn atoms and watch molecules self-assemble by valence rules — then heat the box until they shake apart.' },

  // ---- Foundations ----
  { id: 'quantum', title: 'Quantum & Atomic Structure', tag: 'Foundations', group: 'Foundations', icon: 'atom', estMinutes: 45, difficulty: ['CCC'], prereqs: [],
    blurb: 'Real hydrogen orbitals, radial distributions, spectral series, and an electron-configuration builder.' },
  { id: 'periodicity', title: 'Periodicity', tag: 'Foundations', group: 'Foundations', icon: 'atom', estMinutes: 35, difficulty: ['CCC'], prereqs: ['quantum'],
    blurb: 'Interactive trend curves with the IE/EA anomalies annotated, a Slater\'s-rules Z_eff calculator, and amphoterism.' },
  { id: 'bonding', title: 'Bonding, VSEPR & MO Theory', tag: 'Foundations', group: 'Foundations', icon: 'molecule', estMinutes: 45, difficulty: ['CCC', 'USNCO'], prereqs: ['quantum', 'periodicity'],
    blurb: 'Every VSEPR shape with lone-pair sketches, plus MO diagrams that explain why O₂ is magnetic.' },
  { id: 'stoich', title: 'Stoichiometry & Solutions', tag: 'Foundations', group: 'Foundations', icon: 'scale', estMinutes: 35, difficulty: ['CCC'], prereqs: [],
    blurb: 'Limiting reagents you can see, molarity and dilution tools, and the empirical-formula recipe.' },

  // ---- Physical Chemistry ----
  { id: 'thermo1', title: 'Thermodynamics I', tag: 'Physical', group: 'Physical Chemistry', icon: 'thermo', estMinutes: 40, difficulty: ['CCC'], prereqs: ['stoich'],
    blurb: 'Calorimetry mixing, Hess\'s law cycles, Born–Haber, and estimating ΔH from bond enthalpies.' },
  { id: 'thermo2', title: 'Thermodynamics II', tag: 'Physical', group: 'Physical Chemistry', icon: 'thermo', estMinutes: 40, difficulty: ['USNCO'], prereqs: ['thermo1'],
    blurb: 'Entropy as microstate counting, the ΔG = ΔH − TΔS spontaneity map, and the ΔG° ↔ K converter.' },
  { id: 'gases', title: 'Gases, IMFs & Phases', tag: 'Physical', group: 'Physical Chemistry', icon: 'gas', estMinutes: 45, difficulty: ['USNCO'], prereqs: ['stoich'],
    blurb: 'A kinetic gas box, Maxwell–Boltzmann curves, draggable phase diagrams, Clausius–Clapeyron.' },
  { id: 'equilibrium', title: 'Chemical Equilibrium', tag: 'Physical', group: 'Physical Chemistry', icon: 'equilibrium', estMinutes: 45, difficulty: ['CCC', 'USNCO'], prereqs: ['thermo2'],
    blurb: 'A live N₂O₄ ⇌ 2NO₂ system you can shove around, an ICE solver, and the full Ksp toolkit.' },
  { id: 'aek', title: 'Acids, Redox & Kinetics', tag: 'Physical', group: 'Physical Chemistry', icon: 'bolt', estMinutes: 55, difficulty: ['USNCO'], prereqs: ['equilibrium'],
    blurb: 'Titration curves with a working buret, buffer design, galvanic cells, Latimer diagrams, and rate laws.' },
  { id: 'physchem', title: 'Advanced Physical Chemistry', tag: 'Physical', group: 'Physical Chemistry', icon: 'thermo', estMinutes: 50, difficulty: ['USNCO', 'CCO'], prereqs: ['equilibrium', 'thermo2'],
  ...
  { id: 'biophys', title: 'Physical & Biochemistry', tag: 'Physical', group: 'Physical Chemistry', icon: 'dna', estMinutes: 45, difficulty: ['CCO', 'IChO'], prereqs: ['thermo2', 'aek'],
    blurb: 'Michaelis–Menten, Eyring transition-state theory, Boltzmann populations and bioenergetics (CCO PS4).' },

  // ---- Organic Chemistry ----
  { id: 'organic1', title: 'Organic I — Mechanisms', tag: 'Organic', group: 'Organic Chemistry', icon: 'molecule', estMinutes: 40, difficulty: ['USNCO'], prereqs: ['bonding'],
    blurb: 'The SN1 / SN2 / E1 / E2 decision engine, the pKa ladder, and carbocation stability.' },
  { id: 'organic2', title: 'Organic II & Symmetry', tag: 'Organic', group: 'Organic Chemistry', icon: 'molecule', estMinutes: 45, difficulty: ['USNCO', 'CCO'], prereqs: ['organic1'],
    blurb: 'Markovnikov predictions, EAS directing effects, the carbonyl map, Hückel aromaticity, and point groups.' },
  { id: 'organic3', title: 'Organic III — Synthesis', tag: 'Organic', group: 'Organic Chemistry', icon: 'molecule', estMinutes: 50, difficulty: ['USNCO', 'CCO'], prereqs: ['organic2'],
  ...
  { id: 'polymers', title: 'Polymers', tag: 'Organic', group: 'Organic Chemistry', icon: 'molecule', estMinutes: 30, difficulty: ['USNCO'], prereqs: ['organic1'],
    blurb: 'Addition vs condensation, monomer↔polymer matching, and Mₙ/Mᵂ/PDI/degree-of-polymerization calculations.' },

  // ---- Inorganic Chemistry ----
  { id: 'nuclear', title: 'Nuclear & Coordination', tag: 'Inorganic', group: 'Inorganic Chemistry', icon: 'atom', estMinutes: 40, difficulty: ['USNCO'], prereqs: ['quantum'],
    blurb: 'Truly random decay against the exponential law, carbon dating, and crystal-field color prediction.' },
  { id: 'coordchem', title: 'Coordination & Organometallic', tag: 'Inorganic', group: 'Inorganic Chemistry', icon: 'crystal', estMinutes: 45, difficulty: ['CCO', 'IChO'], prereqs: ['nuclear', 'bonding'],
  ...
  { id: 'advinorganic', title: 'Advanced Inorganic', tag: 'Inorganic', group: 'Inorganic Chemistry', icon: 'crystal', estMinutes: 45, difficulty: ['CCO', 'IChO'], prereqs: ['bonding', 'nuclear'],
    blurb: 'LFSE and term symbols, unit-cell packing and Bragg\'s law, radius-ratio rules and descriptive chemistry (CCO PS3).' },

  // ---- Laboratory Skills ----
  { id: 'labdata', title: 'Lab & Data', tag: 'Skills', group: 'Laboratory Skills', icon: 'flask', estMinutes: 40, difficulty: ['CCC', 'USNCO'], prereqs: ['stoich'],
    blurb: 'Beer\'s law calibration, sig figs, uncertainty propagation + Q-test, qualitative tests, and titration technique.' },
  { id: 'labtech', title: 'Laboratory Techniques', tag: 'Skills', group: 'Laboratory Skills', icon: 'flask', estMinutes: 45, difficulty: ['CCC', 'USNCO'], prereqs: ['labdata'],
  ...
  { id: 'analytical', title: 'Analytical & Quantitative', tag: 'Skills', group: 'Laboratory Skills', icon: 'flask', estMinutes: 40, difficulty: ['CCO'], prereqs: ['equilibrium', 'labdata'],
    blurb: 'EDTA titration curves, Debye–Hückel activity, gravimetric factors, and separations — the core of CCO PS1.' },

  // ---- Spectroscopy ----
  { id: 'spectroscopy', title: 'Spectroscopy & Synthesis', tag: 'Spectroscopy', group: 'Spectroscopy', icon: 'molecule', estMinutes: 50, difficulty: ['CCO', 'IChO'], prereqs: ['bonding', 'organic1'],
    blurb: 'IR, ¹H-NMR splitting and mass-spec interpretation, plus named-reaction and pericyclic synthesis (CCO PS2).' },
  { id: 'structure', title: 'Structure Determination', tag: 'Spectroscopy', group: 'Spectroscopy', icon: 'molecule', estMinutes: 45, difficulty: ['CCO', 'IChO'], prereqs: ['spectroscopy'],
  ...
  // ---- Practice ----
  { id: 'qbank', title: 'Exam Question Bank', tag: 'Practice', group: 'Practice', wide: true, icon: 'book', estMinutes: 90, difficulty: ['CCC', 'USNCO', 'CCO'], prereqs: [],
