...
export const paper5: OlympiadPaper = {
  ...
  partA: [
    ...
    { id: 'mock5-a-007', topic: 'acids', q: 'A diprotic acid \\(\\ce{H2A}\\) has Ka₁ = 1.0×10⁻³ and Ka₂ = 1.0×10⁻⁸. In 0.10 M solution, [H⁺] is governed mainly by:', opts: ['Ka₁ (first ionization)', 'Ka₂ only', 'the sum Ka₁+Ka₂', 'Kw'], a: 0, why: 'Ka₁ ≫ Ka₂, so the first ionization dominates [H⁺]; the second contributes negligibly.' },
    ...
    { id: 'mock5-a-013', topic: 'bonding', q: 'According to MO theory, the species with bond order 2.5 is:', opts: ['\\(\\ce{N2}\\)', '\\(\\ce{O2+}\\)', '\\(\\ce{O2}\\)', '\\(\\ce{F2}\\)'], a: 1, why: 'O₂⁺ removes one antibonding electron from O₂ (BO 2) → bond order 2.5.' },
    ...
    { id: 'mock5-a-015', topic: 'bonding', q: 'The strongest hydrogen bonding occurs in:', opts: ['\\(\\ce{CH3OCH3}\\)', '\\(\\ce{CH3F}\\)', '\\(\\ce{CH3CHO}\\)', '\\(\\ce{CH3CH2OH}\\)'], a: 3, why: 'Ethanol has an O–H group (H bonded to O) → true hydrogen bonding; the ether/aldehyde lack O–H.' },
    ...
    { id: 'mock5-a-018', topic: 'organic', q: 'Which test distinguishes an aldehyde from a ketone?', opts: ['Tollens\' reagent (silver mirror)', 'bromine water', 'flame test', 'litmus'], a: 0, why: 'Tollens\' oxidizes aldehydes (silver mirror) but not ketones.' },
    ...
    { id: 'mock5-a-020', topic: 'lab', q: 'In a Beer\'s-law calibration, absorbance is plotted against concentration. The slope equals:', opts: ['the path length', '1/ε', 'the wavelength', 'the molar absorptivity × path length (εℓ)'], a: 3, why: 'A = εℓc, so a plot of A vs c has slope εℓ.' },
