...
/**
 * The placeholder blurb every contest page carries until Prompt 16 writes it.
 * Stated once so the nine are identical on purpose rather than by accident.
 */
const contestBlurb = (title: string): string =>
  `The contest layer of ${title}: what a contest adds on top of the course.`;
...
export const TOPICS: TopicMeta[] = [
  ...
  // ---- Foundations ----
  { id: 'quantum', slug: 'quantum-and-atomic-structure', aliases: ['quantum', 'atomic-structure'], title: 'Atoms & Electrons', tag: 'Foundations', group: 'Foundations', icon: 'atom', estMinutes: 45, difficulty: ['HS'], prereqs: [], layer: 'course',
  ...
  { id: 'quantum-contest', slug: 'atoms-and-electrons-contest', aliases: ['quantum-contest'], title: 'Atoms & Electrons — Contest', tag: 'Foundations', group: 'Foundations', icon: 'atom', estMinutes: 25, difficulty: ['CCC'], prereqs: ['quantum'], layer: 'contest', parent: 'quantum',
    blurb: contestBlurb('Atoms & Electrons'),
    intro: '',
    refs: QUANTUM_REFS },
  { id: 'periodicity', slug: 'periodicity', aliases: ['periodicity'], title: 'Periodicity', tag: 'Foundations', group: 'Foundations', icon: 'atom', estMinutes: 35, difficulty: ['HS'], prereqs: ['quantum'], layer: 'course',
  ...
  { id: 'periodicity-contest', slug: 'periodicity-contest', aliases: ['periodicity-contest'], title: 'Periodicity — Contest', tag: 'Foundations', group: 'Foundations', icon: 'atom', estMinutes: 25, difficulty: ['CCC'], prereqs: ['periodicity'], layer: 'contest', parent: 'periodicity',
    blurb: contestBlurb('Periodicity'),
    intro: '',
    refs: PERIODICITY_REFS },
  { id: 'bonding', slug: 'bonding-vsepr-and-mo-theory', aliases: ['bonding', 'vsepr', 'mo-theory'], title: 'Bonding & Molecular Shape', tag: 'Foundations', group: 'Foundations', icon: 'molecule', estMinutes: 45, difficulty: ['HS'], prereqs: ['quantum', 'periodicity'], layer: 'course',
  ...
  { id: 'bonding-contest', slug: 'bonding-and-molecular-shape-contest', aliases: ['bonding-contest'], title: 'Bonding & Molecular Shape — Contest', tag: 'Foundations', group: 'Foundations', icon: 'molecule', estMinutes: 25, difficulty: ['CCC', 'USNCO'], prereqs: ['bonding'], layer: 'contest', parent: 'bonding',
    blurb: contestBlurb('Bonding & Molecular Shape'),
    intro: '',
    refs: BONDING_REFS },
  { id: 'stoich', slug: 'stoichiometry-and-solutions', aliases: ['stoich', 'stoichiometry'], title: 'Moles & Solutions', tag: 'Foundations', group: 'Foundations', icon: 'scale', estMinutes: 35, difficulty: ['HS'], prereqs: [], layer: 'course',
  ...
  { id: 'stoich-contest', slug: 'moles-and-solutions-contest', aliases: ['stoich-contest'], title: 'Moles & Solutions — Contest', tag: 'Foundations', group: 'Foundations', icon: 'scale', estMinutes: 25, difficulty: ['CCC'], prereqs: ['stoich'], layer: 'contest', parent: 'stoich',
    blurb: contestBlurb('Moles & Solutions'),
    intro: '',
    refs: STOICH_REFS },

  // ---- Physical Chemistry ----
  { id: 'thermo1', slug: 'thermodynamics-i', aliases: ['thermo1'], title: 'Thermodynamics I', tag: 'Physical', group: 'Physical Chemistry', icon: 'thermo', estMinutes: 40, difficulty: ['HS'], prereqs: ['stoich'], layer: 'course',
  ...
  { id: 'thermo1-contest', slug: 'thermodynamics-i-contest', aliases: ['thermo1-contest'], title: 'Thermodynamics I — Contest', tag: 'Physical', group: 'Physical Chemistry', icon: 'thermo', estMinutes: 25, difficulty: ['CCC'], prereqs: ['thermo1'], layer: 'contest', parent: 'thermo1',
    blurb: contestBlurb('Thermodynamics I'),
    intro: '',
    refs: THERMO1_REFS },
  ...
  { id: 'equilibrium', slug: 'chemical-equilibrium', aliases: ['equilibrium'], title: 'Chemical Equilibrium', tag: 'Physical', group: 'Physical Chemistry', icon: 'equilibrium', estMinutes: 45, difficulty: ['HS'], prereqs: ['thermo1'], layer: 'course',
  ...
  { id: 'equilibrium-contest', slug: 'chemical-equilibrium-contest', aliases: ['equilibrium-contest'], title: 'Chemical Equilibrium — Contest', tag: 'Physical', group: 'Physical Chemistry', icon: 'equilibrium', estMinutes: 25, difficulty: ['CCC', 'USNCO'], prereqs: ['equilibrium'], layer: 'contest', parent: 'equilibrium',
    blurb: contestBlurb('Chemical Equilibrium'),
    intro: '',
    refs: EQUILIBRIUM_REFS },
  { id: 'aek', slug: 'acids-redox-and-kinetics', aliases: ['aek', 'redox', 'kinetics'], title: 'Acids, Batteries & Reaction Rates', tag: 'Physical', group: 'Physical Chemistry', icon: 'bolt', estMinutes: 55, difficulty: ['HS'], prereqs: ['equilibrium'], layer: 'course',
  ...
  { id: 'aek-contest', slug: 'acids-batteries-and-reaction-rates-contest', aliases: ['aek-contest'], title: 'Acids, Batteries & Reaction Rates — Contest', tag: 'Physical', group: 'Physical Chemistry', icon: 'bolt', estMinutes: 25, difficulty: ['USNCO'], prereqs: ['aek'], layer: 'contest', parent: 'aek',
    blurb: contestBlurb('Acids, Batteries & Reaction Rates'),
    intro: '',
    refs: AEK_REFS },
  ...
  // ---- Laboratory Skills ----
  { id: 'labdata', slug: 'lab-and-data', aliases: ['labdata'], title: 'Lab & Data', tag: 'Skills', group: 'Laboratory Skills', icon: 'flask', estMinutes: 40, difficulty: ['HS'], prereqs: ['stoich'], layer: 'course',
  ...
  { id: 'labdata-contest', slug: 'lab-and-data-contest', aliases: ['labdata-contest'], title: 'Lab & Data — Contest', tag: 'Skills', group: 'Laboratory Skills', icon: 'flask', estMinutes: 25, difficulty: ['CCC', 'USNCO'], prereqs: ['labdata'], layer: 'contest', parent: 'labdata',
    blurb: contestBlurb('Lab & Data'),
    intro: '',
    refs: LABDATA_REFS },
  { id: 'labtech', slug: 'laboratory-techniques', aliases: ['labtech'], title: 'Laboratory Techniques', tag: 'Skills', group: 'Laboratory Skills', icon: 'flask', estMinutes: 45, difficulty: ['HS'], prereqs: ['labdata'], layer: 'course',
  ...
  { id: 'labtech-contest', slug: 'laboratory-techniques-contest', aliases: ['labtech-contest'], title: 'Laboratory Techniques — Contest', tag: 'Skills', group: 'Laboratory Skills', icon: 'flask', estMinutes: 25, difficulty: ['CCC', 'USNCO'], prereqs: ['labtech'], layer: 'contest', parent: 'labtech',
    blurb: contestBlurb('Laboratory Techniques'),
    intro: '',
    refs: LABTECH_REFS },
