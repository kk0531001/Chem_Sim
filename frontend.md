...
- [ ] **2. Add `.btn-quiet` + run the primary-action audit**
...
- [ ] **3. Visible search input in the sidebar**
...
- [ ] **7. Continue / Recommended block on the homepage**
...
- [ ] **9. Mastery strip in the sidebar footer**
