...
export const paper1: OlympiadPaper = {
  ...
  partA: [
    { id: 'mock1-a-001', topic: 'stoich', q: 'A compound is 40.0% C, 6.7% H, 53.3% O by mass. Its empirical formula is:', opts: ['CHO', 'CH₂O', 'C₂H₄O', 'CH₄O'], a: 1, why: 'Moles: C 40/12=3.33, H 6.7/1=6.7, O 53.3/16=3.33 → 1:2:1 → CH₂O.' },
    ...
    { id: 'mock1-a-012', topic: 'atomic', q: 'Which of these has the largest first ionization energy: Na, Mg, Al, Si?', opts: ['Na', 'Mg', 'Al', 'Si'], a: 3, why: 'IE rises across the period (with Al < Mg dip); Si is farthest right here, so highest.' },
    ...
    { id: 'mock1-a-015', topic: 'bonding', q: 'The hybridization of carbon in \\(\\ce{CO2}\\) is:', opts: ['sp', 'sp²', 'sp³', 'sp³d'], a: 0, why: 'Two σ bonds and no lone pairs on C (2 electron domains) → sp.' },
