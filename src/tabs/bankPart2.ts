...
export const PART2: FRQ[] = [
  ...
  },
  {
    ...
    prompt: 'Three compounds share the formula <b>C₈H₈O₂</b> (M⁺ = 136). Their data:<br><table class="ref-table"><tr><td></td><td><b>A</b></td><td><b>B</b></td><td><b>C</b></td></tr><tr><td>IR / cm⁻¹</td><td>2500–3300 (v. broad), 1705</td><td>1720, 1280 &amp; 1120</td><td>1740, 1230</td></tr><tr><td>¹H δ</td><td>12.1 (1H, s); 7.4–7.3 (5H, m); 3.6 (2H, s)</td><td>8.0 (2H, d); 7.5 (3H, m); 3.9 (3H, s)</td><td>7.4–7.1 (5H, m); 5.1 (2H, s); 2.1 (3H, s)</td></tr><tr><td>¹³C signals</td><td>6</td><td>6</td><td>7</td></tr></table>',
    parts: [
