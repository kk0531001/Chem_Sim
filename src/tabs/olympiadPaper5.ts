...
export const paper5: OlympiadPaper = {
  ...
  partA: [
    ...
    { id: 'mock5-a-007', topic: 'acids', q: 'A diprotic acid \\(\\ce{H2A}\\) has Ka₁ = 1.0×10⁻³ and Ka₂ = 1.0×10⁻⁸. In 0.10 M solution, [H⁺] is governed mainly by:', opts: ['Ka₁', 'Ka₂ alone', 'the sum of Ka₁ and Ka₂', 'Kw for water'], a: 0, why: 'Ka₁ ≫ Ka₂, so the first ionization dominates [H⁺]; the second contributes negligibly.' },
    ...
    { id: 'mock5-a-020', topic: 'lab', q: 'In a Beer\'s-law calibration, absorbance is plotted against concentration. The slope equals:', opts: ['the path length ℓ', '1/ε only', 'the wavelength used', 'εℓ'], a: 3, why: 'A = εℓc, so a plot of A vs c has slope εℓ.' },
